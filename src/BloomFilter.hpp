 ...
 *
 * - added containsinsert() method
 * - added get_filter_as_bytes() method
 * - added load_filter_from_bytes() method
 * - added clear_bytes() method
 * - added print_filter() method
 * - added get_inserted_element_count() getter
 *
 *********************************************************************
*/
...
public:
   ...
   void print_filter()
   {
      ...
      std::cout << "Salts: " << salt_.size() << " (by \"salt_count_\" parameter: ";
      std::cout << salt_count_ << ")" << std::endl;
      for (size_t i = 0; i < salt_.size(); ++i){
         if (i+1 < 10)        std::cout << "    ";
         else if (i+1 < 100)  std::cout << "   ";
         else                 std::cout << "  ";
         std::cout << i+1 << ". " << std::right << std::setw(15) << salt_[i] << std::endl;
      }
      std::cout << std::endl;
      std::cout << "Random seed:                        " << std::right << std::setw(23) << random_seed_ << std::endl;
      std::cout << "Projected element count:            " << std::right << std::setw(23) << projected_element_count_ << std::endl;
      std::cout << "Desired false positive probability: " << std::right << std::setw(23) << desired_false_positive_probability_ << std::endl;
      std::cout << "Table size:                         " << std::right << std::setw(23) << table_size_ << std::endl;
      std::cout << "Raw table size:                     " << std::right << std::setw(23) << raw_table_size_ << std::endl;
      std::cout << "Inserted element count:             " << std::right << std::setw(23) << inserted_element_count_ << std::endl;
      std::cout << "-----------------------------------------------------------" << std::endl;
   }
